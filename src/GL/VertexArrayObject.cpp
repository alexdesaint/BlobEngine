...
void VertexArrayObject::setArray(GLuint numValuePerArray, GLuint outPosition, GLenum dataType, GLuint relativeOffset, bool normalized, GLuint bufferPosition) const {
...
template<>
void VertexArrayObject::setArray<float>(GLuint numValuePerArray, GLuint outPosition, GLuint relativeOffset, bool normalized, uint32_t bufferPosition) const {
    setArray(numValuePerArray, outPosition, GL_FLOAT, relativeOffset, normalized, bufferPosition);
}
...
void VertexArrayObject::setArray<uint8_t>(uint32_t numValuePerArray, uint32_t outPosition, uint32_t relativeOffset, bool normalized, uint32_t bufferPosition) const {
    setArray(numValuePerArray, outPosition, GL_UNSIGNED_BYTE, relativeOffset, normalized, bufferPosition);
}
...
void VertexArrayObject::setArray<uint16_t>(uint32_t numValuePerArray, uint32_t outPosition, uint32_t relativeOffset, bool normalized, uint32_t bufferPosition) const {
    setArray(numValuePerArray, outPosition, GL_UNSIGNED_SHORT, relativeOffset, normalized, bufferPosition);
}
...
void VertexArrayObject::setArray<uint32_t>(uint32_t numValuePerArray, uint32_t outPosition, uint32_t relativeOffset, bool normalized, uint32_t bufferPosition) const {
    setArray(numValuePerArray, outPosition, GL_UNSIGNED_INT, relativeOffset, normalized, bufferPosition);
}
...
void VertexArrayObject::setArray<int8_t>(uint32_t numValuePerArray, uint32_t outPosition, uint32_t relativeOffset, bool normalized, uint32_t bufferPosition) const {
    setArray(numValuePerArray, outPosition, GL_BYTE, relativeOffset, normalized, bufferPosition);
}
...
void VertexArrayObject::setArray<int16_t>(uint32_t numValuePerArray, uint32_t outPosition, uint32_t relativeOffset, bool normalized, uint32_t bufferPosition) const {
    setArray(numValuePerArray, outPosition, GL_SHORT, relativeOffset, normalized, bufferPosition);
}
...
void VertexArrayObject::setArray<int32_t>(uint32_t numValuePerArray, uint32_t outPosition, uint32_t relativeOffset, bool normalized, uint32_t bufferPosition) const {
    setArray(numValuePerArray, outPosition, GL_INT, relativeOffset, normalized, bufferPosition);
}
} // namespace Blob::GL
