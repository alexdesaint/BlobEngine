...
Surface::Surface(const Blob::GLFW::Window &window, const Instance &instance) :
    instance(instance) {
    if (glfwCreateWindowSurface(instance.instance,
...
PhysicalDevice::getPhysicalDevices(const Instance &instance) {
    uint32_t deviceCount = 0;
    vkEnumeratePhysicalDevices(instance.instance, &deviceCount, nullptr);
...
PhysicalDevice PhysicalDevice::pickPhysicalDevice(const Instance &instance,
...
PhysicalDevice::querySwapChainSupport(const Surface &surface) const {
