...
static bool LOCAL_UNKNOWN = false, LOCAL_SPACE = false, LOCAL_APOSTROPHE = false, LOCAL_COMMA = false, LOCAL_MINUS = false, LOCAL_PERIOD = false,
            ...
            LOCAL_NUM_5 = false, LOCAL_NUM_6 = false, LOCAL_NUM_7 = false, LOCAL_NUM_8 = false, LOCAL_NUM_9 = false, LOCAL_SEMICOLON = false,
            LOCAL_EQUAL = false, LOCAL_A = false, LOCAL_B = false, LOCAL_C = false, LOCAL_D = false, LOCAL_E = false, LOCAL_F = false,
            LOCAL_G = false, LOCAL_H = false, LOCAL_I = false, LOCAL_J = false, LOCAL_K = false, LOCAL_L = false, LOCAL_M = false, LOCAL_N = false,
            LOCAL_O = false, LOCAL_P = false, LOCAL_Q = false, LOCAL_R = false, LOCAL_S = false, LOCAL_T = false, LOCAL_U = false, LOCAL_V = false,
            LOCAL_W = false, LOCAL_X = false, LOCAL_Y = false, LOCAL_Z = false, LOCAL_LEFT_BRACKET = false, LOCAL_BACKSLASH = false,
            LOCAL_RIGHT_BRACKET = false, LOCAL_GRAVE_ACCENT = false, LOCAL_WORLD_1 = false, LOCAL_WORLD_2 = false, LOCAL_ESCAPE = false,
            LOCAL_ENTER = false, LOCAL_TAB = false, LOCAL_BACKSPACE = false, LOCAL_INSERT = false, LOCAL_DELETE = false, LOCAL_RIGHT = false,
            LOCAL_LEFT = false, LOCAL_DOWN = false, LOCAL_UP = false, LOCAL_PAGE_UP = false, LOCAL_PAGE_DOWN = false, LOCAL_HOME = false,
            LOCAL_END = false, LOCAL_CAPS_LOCK = false, LOCAL_SCROLL_LOCK = false, LOCAL_NUM_LOCK = false, LOCAL_PRINT_SCREEN = false,
            LOCAL_PAUSE = false, LOCAL_F1 = false, LOCAL_F2 = false, LOCAL_F3 = false, LOCAL_F4 = false, LOCAL_F5 = false, LOCAL_F6 = false,
            LOCAL_F7 = false, LOCAL_F8 = false, LOCAL_F9 = false, LOCAL_F10 = false, LOCAL_F11 = false, LOCAL_F12 = false, LOCAL_F13 = false,
            LOCAL_F14 = false, LOCAL_F15 = false, LOCAL_F16 = false, LOCAL_F17 = false, LOCAL_F18 = false, LOCAL_F19 = false, LOCAL_F20 = false,
            LOCAL_F21 = false, LOCAL_F22 = false, LOCAL_F23 = false, LOCAL_F24 = false, LOCAL_F25 = false, LOCAL_KP_0 = false, LOCAL_KP_1 = false,
            LOCAL_KP_2 = false, LOCAL_KP_3 = false, LOCAL_KP_4 = false, LOCAL_KP_5 = false, LOCAL_KP_6 = false, LOCAL_KP_7 = false,
            LOCAL_KP_8 = false, LOCAL_KP_9 = false, LOCAL_KP_DECIMAL = false, LOCAL_KP_DIVIDE = false, LOCAL_KP_MULTIPLY = false,
            LOCAL_KP_SUBTRACT = false, LOCAL_KP_ADD = false, LOCAL_KP_ENTER = false, LOCAL_KP_EQUAL = false, LOCAL_LEFT_SHIFT = false,
            LOCAL_LEFT_CONTROL = false, LOCAL_LEFT_ALT = false, LOCAL_LEFT_SUPER = false, LOCAL_RIGHT_SHIFT = false, LOCAL_RIGHT_CONTROL = false,
            LOCAL_RIGHT_ALT = false, LOCAL_RIGHT_SUPER = false, LOCAL_MENU = false;

static bool *keys[GLFW_KEY_LAST + 2];

const bool &Controls::Keys::UNKNOWN = LOCAL_UNKNOWN, &Controls::Keys::SPACE = LOCAL_SPACE, &Controls::Keys::APOSTROPHE = LOCAL_APOSTROPHE,
           &Controls::Keys::COMMA = LOCAL_COMMA, &Controls::Keys::MINUS = LOCAL_MINUS, &Controls::Keys::PERIOD = LOCAL_PERIOD,
           &Controls::Keys::SLASH = LOCAL_SLASH, &Controls::Keys::NUM_0 = LOCAL_NUM_0, &Controls::Keys::NUM_1 = LOCAL_NUM_1,
           &Controls::Keys::NUM_2 = LOCAL_NUM_2, &Controls::Keys::NUM_3 = LOCAL_NUM_3, &Controls::Keys::NUM_4 = LOCAL_NUM_4,
           &Controls::Keys::NUM_5 = LOCAL_NUM_5, &Controls::Keys::NUM_6 = LOCAL_NUM_6, &Controls::Keys::NUM_7 = LOCAL_NUM_7,
           &Controls::Keys::NUM_8 = LOCAL_NUM_8, &Controls::Keys::NUM_9 = LOCAL_NUM_9, &Controls::Keys::SEMICOLON = LOCAL_SEMICOLON,
           &Controls::Keys::EQUAL = LOCAL_EQUAL, &Controls::Keys::A = LOCAL_A, &Controls::Keys::B = LOCAL_B, &Controls::Keys::C = LOCAL_C,
           &Controls::Keys::D = LOCAL_D, &Controls::Keys::E = LOCAL_E, &Controls::Keys::F = LOCAL_F, &Controls::Keys::G = LOCAL_G,
           &Controls::Keys::H = LOCAL_H, &Controls::Keys::I = LOCAL_I, &Controls::Keys::J = LOCAL_J, &Controls::Keys::K = LOCAL_K,
           &Controls::Keys::L = LOCAL_L, &Controls::Keys::M = LOCAL_M, &Controls::Keys::N = LOCAL_N, &Controls::Keys::O = LOCAL_O,
           &Controls::Keys::P = LOCAL_P, &Controls::Keys::Q = LOCAL_Q, &Controls::Keys::R = LOCAL_R, &Controls::Keys::S = LOCAL_S,
           &Controls::Keys::T = LOCAL_T, &Controls::Keys::U = LOCAL_U, &Controls::Keys::V = LOCAL_V, &Controls::Keys::W = LOCAL_W,
           &Controls::Keys::X = LOCAL_X, &Controls::Keys::Y = LOCAL_Y, &Controls::Keys::Z = LOCAL_Z,
           &Controls::Keys::LEFT_BRACKET = LOCAL_LEFT_BRACKET, &Controls::Keys::BACKSLASH = LOCAL_BACKSLASH,
           &Controls::Keys::RIGHT_BRACKET = LOCAL_RIGHT_BRACKET, &Controls::Keys::GRAVE_ACCENT = LOCAL_GRAVE_ACCENT,
           &Controls::Keys::WORLD_1 = LOCAL_WORLD_1, &Controls::Keys::WORLD_2 = LOCAL_WORLD_2, &Controls::Keys::ESCAPE = LOCAL_ESCAPE,
           &Controls::Keys::ENTER = LOCAL_ENTER, &Controls::Keys::TAB = LOCAL_TAB, &Controls::Keys::BACKSPACE = LOCAL_BACKSPACE,
           &Controls::Keys::INSERT = LOCAL_INSERT, &Controls::Keys::DEL = LOCAL_DELETE, &Controls::Keys::RIGHT = LOCAL_RIGHT,
           &Controls::Keys::LEFT = LOCAL_LEFT, &Controls::Keys::DOWN = LOCAL_DOWN, &Controls::Keys::UP = LOCAL_UP,
           &Controls::Keys::PAGE_UP = LOCAL_PAGE_UP, &Controls::Keys::PAGE_DOWN = LOCAL_PAGE_DOWN, &Controls::Keys::HOME = LOCAL_HOME,
           &Controls::Keys::END = LOCAL_END, &Controls::Keys::CAPS_LOCK = LOCAL_CAPS_LOCK, &Controls::Keys::SCROLL_LOCK = LOCAL_SCROLL_LOCK,
           &Controls::Keys::NUM_LOCK = LOCAL_NUM_LOCK, &Controls::Keys::PRINT_SCREEN = LOCAL_PRINT_SCREEN, &Controls::Keys::PAUSE = LOCAL_PAUSE,
           &Controls::Keys::F1 = LOCAL_F1, &Controls::Keys::F2 = LOCAL_F2, &Controls::Keys::F3 = LOCAL_F3, &Controls::Keys::F4 = LOCAL_F4,
           &Controls::Keys::F5 = LOCAL_F5, &Controls::Keys::F6 = LOCAL_F6, &Controls::Keys::F7 = LOCAL_F7, &Controls::Keys::F8 = LOCAL_F8,
           &Controls::Keys::F9 = LOCAL_F9, &Controls::Keys::F10 = LOCAL_F10, &Controls::Keys::F11 = LOCAL_F11, &Controls::Keys::F12 = LOCAL_F12,
           &Controls::Keys::F13 = LOCAL_F13, &Controls::Keys::F14 = LOCAL_F14, &Controls::Keys::F15 = LOCAL_F15, &Controls::Keys::F16 = LOCAL_F16,
           &Controls::Keys::F17 = LOCAL_F17, &Controls::Keys::F18 = LOCAL_F18, &Controls::Keys::F19 = LOCAL_F19, &Controls::Keys::F20 = LOCAL_F20,
           &Controls::Keys::F21 = LOCAL_F21, &Controls::Keys::F22 = LOCAL_F22, &Controls::Keys::F23 = LOCAL_F23, &Controls::Keys::F24 = LOCAL_F24,
           &Controls::Keys::F25 = LOCAL_F25, &Controls::Keys::KP_0 = LOCAL_KP_0, &Controls::Keys::KP_1 = LOCAL_KP_1,
           &Controls::Keys::KP_2 = LOCAL_KP_2, &Controls::Keys::KP_3 = LOCAL_KP_3, &Controls::Keys::KP_4 = LOCAL_KP_4,
           &Controls::Keys::KP_5 = LOCAL_KP_5, &Controls::Keys::KP_6 = LOCAL_KP_6, &Controls::Keys::KP_7 = LOCAL_KP_7,
           &Controls::Keys::KP_8 = LOCAL_KP_8, &Controls::Keys::KP_9 = LOCAL_KP_9, &Controls::Keys::KP_DECIMAL = LOCAL_KP_DECIMAL,
           &Controls::Keys::KP_DIVIDE = LOCAL_KP_DIVIDE, &Controls::Keys::KP_MULTIPLY = LOCAL_KP_MULTIPLY,
           &Controls::Keys::KP_SUBTRACT = LOCAL_KP_SUBTRACT, &Controls::Keys::KP_ADD = LOCAL_KP_ADD, &Controls::Keys::KP_ENTER = LOCAL_KP_ENTER,
           &Controls::Keys::KP_EQUAL = LOCAL_KP_EQUAL, &Controls::Keys::LEFT_SHIFT = LOCAL_LEFT_SHIFT,
           &Controls::Keys::LEFT_CONTROL = LOCAL_LEFT_CONTROL, &Controls::Keys::LEFT_ALT = LOCAL_LEFT_ALT,
           &Controls::Keys::LEFT_SUPER = LOCAL_LEFT_SUPER, &Controls::Keys::RIGHT_SHIFT = LOCAL_RIGHT_SHIFT,
           &Controls::Keys::RIGHT_CONTROL = LOCAL_RIGHT_CONTROL, &Controls::Keys::RIGHT_ALT = LOCAL_RIGHT_ALT,
           &Controls::Keys::RIGHT_SUPER = LOCAL_RIGHT_SUPER, &Controls::Keys::MENU = LOCAL_MENU;
...
void Controls::update() {
    ...
    for (auto c : LOCAL_Controllers) {
        LOCAL_GLFW_Controllers[c->number].buttons = glfwGetJoystickButtons(c->number, &LOCAL_GLFW_Controllers[c->number].buttonsCount);

        LOCAL_GLFW_Controllers[c->number].joystickAxes = glfwGetJoystickAxes(c->number, &LOCAL_GLFW_Controllers[c->number].joystickAxesCount);
    }
}
