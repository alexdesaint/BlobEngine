...
namespace Blob {
    ...
    const bool
            ...
            &Controls::Keys::DELETE = LOCAL_DELETE,
    ...
    std::list<const Controls::Controller* const> LOCAL_Controllers;

    const std::list<const Controls::Controller* const> &Controls::controllers(LOCAL_Controllers);
