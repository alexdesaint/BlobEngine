...
Texture *Colors::maroon, *Colors::darkRed, *Colors::brown, *Colors::firebrick, *Colors::crimson, *Colors::red, *Colors::tomato, *Colors::coral,
    *Colors::indianRed, *Colors::lightCoral, *Colors::darkSalmon, *Colors::salmon, *Colors::lightSalmon, *Colors::orangeRed, *Colors::darkOrange,
    *Colors::orange, *Colors::gold, *Colors::darkGoldenRod, *Colors::goldenRod, *Colors::paleGoldenRod, *Colors::darkKhaki, *Colors::khaki,
    *Colors::olive, *Colors::yellow, *Colors::yellowGreen, *Colors::darkOliveGreen, *Colors::oliveDrab, *Colors::lawnGreen, *Colors::chartReuse,
    *Colors::greenYellow, *Colors::darkGreen, *Colors::green, *Colors::forestGreen, *Colors::lime, *Colors::limeGreen, *Colors::lightGreen,
    *Colors::paleGreen, *Colors::darkSeaGreen, *Colors::mediumSpringGreen, *Colors::springGreen, *Colors::seaGreen, *Colors::mediumAquaMarine,
    *Colors::mediumSeaGreen, *Colors::lightSeaGreen, *Colors::darkSlateGray, *Colors::teal, *Colors::darkCyan, *Colors::aqua, *Colors::cyan,
    *Colors::lightCyan, *Colors::darkTurquoise, *Colors::turquoise, *Colors::mediumTurquoise, *Colors::paleTurquoise, *Colors::aquaMarine,
    *Colors::powderBlue, *Colors::cadetBlue, *Colors::steelBlue, *Colors::cornFlowerBlue, *Colors::deepSkyBlue, *Colors::dodgerBlue,
    *Colors::lightBlue, *Colors::skyBlue, *Colors::lightSkyBlue, *Colors::midnightBlue, *Colors::navy, *Colors::darkBlue, *Colors::mediumBlue,
    *Colors::blue, *Colors::royalBlue, *Colors::blueViolet, *Colors::indigo, *Colors::darkSlateBlue, *Colors::slateBlue, *Colors::mediumSlateBlue,
    *Colors::mediumPurple, *Colors::darkMagenta, *Colors::darkViolet, *Colors::darkOrchid, *Colors::mediumOrchid, *Colors::purple, *Colors::thistle,
    *Colors::plum, *Colors::violet, *Colors::magenta, *Colors::orchid, *Colors::mediumVioletRed, *Colors::paleVioletRed, *Colors::deepPink,
    *Colors::hotPink, *Colors::lightPink, *Colors::pink, *Colors::antiqueWhite, *Colors::beige, *Colors::bisque, *Colors::blanchedAlmond,
    *Colors::wheat, *Colors::cornSilk, *Colors::lemonChiffon, *Colors::lightGoldenRodYellow, *Colors::lightYellow, *Colors::saddleBrown,
    *Colors::sienna, *Colors::chocolate, *Colors::peru, *Colors::sandyBrown, *Colors::burlyWood, *Colors::tan, *Colors::rosyBrown, *Colors::moccasin,
    *Colors::navajoWhite, *Colors::peachPuff, *Colors::mistyRose, *Colors::lavenderBlush, *Colors::linen, *Colors::oldLace, *Colors::papayaWhip,
    *Colors::seaShell, *Colors::mintCream, *Colors::slateGray, *Colors::lightSlateGray, *Colors::lightSteelBlue, *Colors::lavender,
    *Colors::floralWhite, *Colors::aliceBlue, *Colors::ghostWhite, *Colors::honeydew, *Colors::ivory, *Colors::azure, *Colors::snow, *Colors::black,
    *Colors::dimGrey, *Colors::grey, *Colors::darkGrey, *Colors::silver, *Colors::lightGrey, *Colors::gainsboro, *Colors::whiteSmoke, *Colors::white;
...
public:
    ...
    ImGUIData() {
        ...
        vertexArrayObject.setArray<float>(2, Shaders::Shader_2D_POSITION_TEXCOORD_0_COLOR_0->getAttribLocation("Position"),
                                          (uint32_t) offsetof(ImDrawVert, pos));
        vertexArrayObject.setArray<float>(2, Shaders::Shader_2D_POSITION_TEXCOORD_0_COLOR_0->getAttribLocation("TexturePosition"),
                                          (uint32_t) offsetof(ImDrawVert, uv));
        vertexArrayObject.setArray<uint8_t>(4, Shaders::Shader_2D_POSITION_TEXCOORD_0_COLOR_0->getAttribLocation("Color"),
                                            (uint32_t) offsetof(ImDrawVert, col), true);
    }
...
void ImGUI::draw() {
    ...
    for (int n = 0; n < drawData->CmdListsCount; n++) {
        ...
        imGuiData->vertexArrayObject.setBuffer(imguiVBO, sizeof(ImDrawVert), offset * sizeof(ImDrawVert));

        imGuiData->renderOptions.indices = cmd_list->IdxBuffer.Data;
        imGuiData->renderOptions.numOfIndices = cmd_list->IdxBuffer.Size;
        imGuiData->renderOptions.indicesType = GL_UNSIGNED_SHORT;
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++) {
            ...
            Core::draw(imGuiData->renderOptions, *Shaders::Shader_2D_POSITION_TEXCOORD_0_COLOR_0, imGuiData->vertexArrayObject,
                       *((Texture *) pcmd->TextureId), imGuiData->id, imGuiData->id, imGuiData->id);
...
void ImGUI::setWindowSize(unsigned int width, unsigned int height) {
    ...
    imGuiData->projectionMatrix[0] = 2.0f / ((float) width);
    imGuiData->projectionMatrix[5] = 2.0f / -((float) height);
}
} // namespace Blob
...
void init() {
    ...
    vaoCube->setArray(3, Shaders::Shader_3D_POSITION_NORMAL_TEXCOORD_0->getAttribLocation("POSITION"), GL_FLOAT, (uint32_t) offsetof(Data, coor));
    vaoCube->setArray(3, Shaders::Shader_3D_POSITION_NORMAL_TEXCOORD_0->getAttribLocation("NORMAL"), GL_FLOAT, (uint32_t) offsetof(Data, norm));
    vaoCube->setArray(2, Shaders::Shader_3D_POSITION_NORMAL_TEXCOORD_0->getAttribLocation("TEXCOORD_0"), GL_FLOAT,
                      (uint32_t) offsetof(Data, texCoor));

    vaoPlane = new VertexArrayObject();
    vaoPlane->setBuffer(*vbo, sizeof(Data), 4 * 6 * sizeof(Data));
    vaoPlane->setArray(3, Shaders::Shader_3D_POSITION_NORMAL_TEXCOORD_0->getAttribLocation("POSITION"), GL_FLOAT, (uint32_t) offsetof(Data, coor));
    vaoPlane->setArray(3, Shaders::Shader_3D_POSITION_NORMAL_TEXCOORD_0->getAttribLocation("NORMAL"), GL_FLOAT, (uint32_t) offsetof(Data, norm));
    vaoPlane->setArray(2, Shaders::Shader_3D_POSITION_NORMAL_TEXCOORD_0->getAttribLocation("TEXCOORD_0"), GL_FLOAT,
                       (uint32_t) offsetof(Data, texCoor));

    vaoOctagonalPrism = new VertexArrayObject();
    vaoOctagonalPrism->setBuffer(*vbo, sizeof(Data), (4 * 6 + 4) * sizeof(Data));
    vaoOctagonalPrism->setArray(3, Shaders::Shader_3D_POSITION_NORMAL_TEXCOORD_0->getAttribLocation("POSITION"), GL_FLOAT,
                                (uint32_t) offsetof(Data, coor));
    vaoOctagonalPrism->setArray(3, Shaders::Shader_3D_POSITION_NORMAL_TEXCOORD_0->getAttribLocation("NORMAL"), GL_FLOAT,
                                (uint32_t) offsetof(Data, norm));
    vaoOctagonalPrism->setArray(2, Shaders::Shader_3D_POSITION_NORMAL_TEXCOORD_0->getAttribLocation("TEXCOORD_0"), GL_FLOAT,
                                (uint32_t) offsetof(Data, texCoor));
